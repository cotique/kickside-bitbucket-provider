...
local function define_tests()
    test.describe("cotique.bitbucket.client:data_error bare record builders (client/api.lua's own convention)", function()
    ...
    test.describe("cotique.bitbucket.client:data_error real taxonomy envelope builders (pull_core.lua's convention)", function()
